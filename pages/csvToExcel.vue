<template>
  <div class="cmain">
    ...
    <div class="upload">
      <div class="u-wrap">
        <input ref="originFileInput" type="file" name="file" class="u-file" @change="inputUploadChange" accept=".csv,.zip" size="10"/>
        <el-upload
          action=""
          class="upload-item"
          ref="upload"
          ...
          <div class="upload-tip" slot="tip">2.支持上传.zip文件，批量转多个csv文件（收费）。批量转<span @click="contractMe">点这里</span></div>
  ...
  methods:{
    ...
    async startConvert(){
      ...
      if(res.code === 0){
        ...
        this.downFile(res.data.excelUrl,res.data.originFileName)
      }else{
